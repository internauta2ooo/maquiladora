...
function validarFormulario() {
    ...
    listaentradas.forEach(function(currentValue, index, listObject) {
...
function addColumn(tblId) {
    ...
    for (var h = 0; h < tblHeadObj.rows.length; h++) {
        ...
        if (h == 0) {
            ...
            newTH.innerHTML =
                '<input type="number" class="form-control" id="yeah" name="entradastallas" oninput="actualizarValor(this)"/>';
        }
    }
    ...
    for (
        ...
        if (i == 0) {
            ...
            y.innerHTML =
                ...
                document.getElementById("coordinadostabla").innerHTML +
                "</select>";
        } else if (i == 1) {
