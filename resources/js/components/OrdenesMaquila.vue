<template>
  <div class="container">
          ...
          <b-card>
            <b-row class="mb-2">
              ...
              <ul id="listaordenes" style="list-style-type:none;">
                <li id="ordenes" v-for="item in row.item.numerodeprendas">
              ...
              <b-col sm="3" class="text-sm-right">
                <b>Total de piezas: </b>{{row.item.totalpiezas}}
              </b-col>
            </b-row>
    ...
    <b-button variant="primary" @click="actualizarAlgo()">Ya soy reactivo</b-button>
  </div>
</template>
