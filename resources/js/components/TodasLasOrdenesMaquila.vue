...
export default {
  ...
  methods: {
    ...
    obtenerOrdenesMaquila() {
      console.log("deberia llegar ahstasa acaa1");
      let _this = this;
      Swal.fire({
      ...
      axios
        .get("obtenertodaslasordenesmaquila")
        .then((response) => {
        ...
        .catch((error) => {
          console.log("deberia llegar ahstasa acaa2");
          window.location.href = "todaslasordenesmaquila";
        });
    },
